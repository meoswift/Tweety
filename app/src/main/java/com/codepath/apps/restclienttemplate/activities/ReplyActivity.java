...
public class ReplyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        composer.setHint("In reply to " + tweet.user.username);
        composer.setText(tweet.user.username);
    }
        ...
        client.publishTweet(tweet, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                try {
                    ...
                    // Notify user that reply is successful
                    Toast.makeText(ReplyActivity.this, "Reply sent!", Toast.LENGTH_SHORT).show();
